...
public class JUnitEventTimeStamps {
	...
	public void setUp() throws Exception {
		...
		loader = new TEOOWLAPILoader("src//test//resources//TEO//TEOAnnotation_7.owl");
...
//		System.out.println("Querier: preparing the querier completes.\n");
	...
	public void testGetEventByIRIStr() {
		...
		Event event1 = querier.getEventByIRIStr("http://www.cse.lehigh.edu/~yil712/TEO/annotation_7.owl#Event1");
		Event event2 = querier.getEventByIRIStr("http://www.cse.lehigh.edu/~yil712/TEO/annotation_7.owl#Event2");
		Event event3 = querier.getEventByIRIStr("http://www.cse.lehigh.edu/~yil712/TEO/annotation_7.owl#Event3");
		Event event4 = querier.getEventByIRIStr("http://www.cse.lehigh.edu/~yil712/TEO/annotation_7.owl#Event4");
//		Event event5 = querier.getEventByIRIStr("http://www.cse.lehigh.edu/~yil712/TEO/annotation_7.owl#Event5");
//		Event event6 = querier.getEventByIRIStr("http://www.cse.lehigh.edu/~yil712/TEO/annotation_7.owl#Event6");
